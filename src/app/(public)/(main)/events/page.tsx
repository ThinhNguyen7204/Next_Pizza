    ...
    return (
        <div className="min-h-screen bg-cream">
            {/* <PageHero 
                ...
                title={<>Experiences <span className="cursive text-gold">Worth Savouring</span></>}
                subtitle="Exclusive evenings where pizza meets art, culture, and community. Reserve your spot before we're full."
            /> */}
